...
import { createHymnaryResolver, detailHymnaryResolver, getExistingHymnaryResolver, getExistingHymnaryTitlesResolver, updatedTitleDetailHymnaryResolver } from "~/tests/mocks/handlers/hymnary";
...
test("should change hymnary title", async ({ page }) => {
  ...
  page.route("*/**/api/hymnary/1/", updatedTitleDetailHymnaryResolver);
