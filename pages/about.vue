...
<template>
  <section class="mt-8">
    <p>
      ...
      desenvolvido com uma abordagem inovadora para a montagem de hinários, com
      foco na praticidade e facilidade de uso, já que convencionalmente todo o
    ...
    <p>
      ...
      utilizado no desenvolvimento web. Já o Bootstrap é um framework front-end
      que permite a criação de interfaces responsivas e elegantes, com uma ampla
      variedade de recursos e componentes.
    </p>
